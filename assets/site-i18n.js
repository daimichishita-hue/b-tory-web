(function(){
  ...
  merge(BUSINESS_COPY.zh=BUSINESS_COPY.zh||{},{
    ...
    pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","¥1,980/月","¥4,980/月 计划","¥9,800/月起 计划"],subs:["","¥19,800/年 计划","¥49,800/年 计划",""],titles:["想先试用的沙龙","一人沙龙和小型沙龙的正式运营","团队运营和多设备","多店铺、联动和自动化"],descriptions:["可小规模试用 B-tory 基本流程的体验版。正式的库存、订货和收据管理建议使用 Starter。","面向希望扎实使用每日库存确认、订货、入库和收据管理的沙龙。B-tory 的核心计划。","面向希望使用多员工、多设备和云备份的沙龙。","面向考虑多店铺、外部联动、AI/OCR等高级运营的沙龙。"],features:[["商品登记最多50件","照片最多30张","文件最多10件","文件容量最多100MB","供应商最多5个","员工1名 / 设备1台","订单每月最多5件","Excel订单模板每月最多2件","材料费率仅简易显示","仅手动JSON备份","无云同步","无多设备同步","无员工共享"],["商品登记最多300件","照片最多300张","文件最多1GB","供应商最多30个","员工1〜2名","订单创建限制放宽","Excel订单模板限制放宽","按供应商/制造商/分类整理","收据/送货单/发票管理","材料费率报告","JSON备份","iPhone / iPad / Mac / Windows 计划支持"],["Starter全部功能","商品登记最多1000件","照片最多1000张","文件最多5GB","供应商最多100个","员工最多5名","B-tory账号","云备份","多设备同步","员工共享","操作历史","详细分析","文件容量提升","照片容量提升"],["Pro全部功能","商品大容量／需咨询","照片大容量／需咨询","文件50GB起","10名以上员工","多店铺","POS/预约网站联动","会计联动","AI/OCR","LINE官方联动","WhatsApp Business","专属支持"]],buttons:["Free Starter 计划开始","Starter 准备中","Pro 准备中","Max 准备中"],notes:["※价格、功能和免费试用均为计划。首次发布计划从 Free Starter 开始。","※Starter 30天试用、付费计划、账号、云备份、多设备同步、AI/OCR和外部联动均在未来更新中考虑。"]},
