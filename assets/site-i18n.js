(function(){
  ...
  var COPY={
    en:{
      ...
      difference:{
        eyebrow:"Reasons",
        title:"Why salons choose B-tory",
    ...
    ja:{
      ...
      difference:{
        ...
        titles:["Excelから始めて、スマホでかんたん管理","発注・納品の抜け漏れを減らせる","領収書・納品書まであとから探せる"],
        bodies:["Excel/CSVや既存の在庫表から商品を取り込み、写真・バーコードでも登録・確認できます。カラー剤、店販商品、備品まで、営業中でもその場で在庫を見つけやすくします。","要発注の確認、発注書作成、入荷待ち、納品登録までを一連で管理。紙やExcelで起きやすい発注漏れ・確認漏れを減らします。","領収書、納品書、請求書を写真やPDFで保存。発注番号、仕入先、商品名であとから探せるので、材料管理や確認作業がスムーズになります。"],
        visualLabels:["写真","バーコード","在庫 7","要発注","発注","入荷待ち","納品","領収書","納品書","請求書","発注番号 / 仕入先 / 商品名"]
      },
      workflow:{
        eyebrow:"How it works",
        title:"基本の流れ",
    ...
    zh:{
      ...
      difference:{eyebrow:"Reasons",title:"沙龙选择 B-tory 的理由",body:"把容易分散在纸张、Excel 和备忘中的沙龙材料管理，变成现场更容易使用的流程。",titles:["从 Excel 开始，用手机轻松管理。","减少订货和入库确认遗漏","收据和送货单之后也能查找"],bodies:["可从 Excel/CSV 或现有库存表导入商品，也可用照片和条码登记与确认。染膏、店售商品和备品在营业中也更容易找到。","把需订货确认、订单创建、等待入库和入库登记连成一个流程，减少纸张或 Excel 常见的订货漏、确认漏。","用照片或 PDF 保存收据、送货单和发票。之后可按订单号、供应商或商品名查找，让材料管理更顺畅。"],visualLabels:["照片","条码","库存 7","需订货","订货","等待入库","已入库","收据","送货单","发票","订单号 / 供应商 / 商品名"]},
    ...
    es:{
      ...
      difference:{eyebrow:"Reasons",title:"Por qué los salones eligen B-tory",body:"Convierte la gestión de materiales dispersa en papel, Excel y notas en un flujo fácil de usar en el salón.",titles:["Empieza desde Excel y gestiona fácilmente desde el móvil.","Reduce pedidos omitidos y revisiones de recepción","Recibos y albaranes fáciles de buscar"],bodies:["Importa productos desde Excel/CSV o listas de inventario existentes, y registra o revisa artículos con fotos y códigos de barras. Coloración, venta y suministros son más fáciles de encontrar durante el servicio.","Gestiona bajo stock, órdenes, pendientes y recepción como un solo flujo. Reduce olvidos de pedido y revisión que ocurren con papel o Excel.","Guarda recibos, albaranes y facturas como foto o PDF. Busca después por número de pedido, proveedor o producto para trabajar con más fluidez."],visualLabels:["Foto","Código","Stock 7","Reposición","Pedido","Pendiente","Recibido","Recibo","Albarán","Factura","N.º pedido / Proveedor / Producto"]},
  ...
  var BUSINESS_COPY={
    en:{
      ...
      features:{eyebrow:"With B-tory",title:"Make salon inventory work more efficient.",body:"Bring inventory, ordering, receiving, receipts, and material-cost data out of paper, Excel, and scattered notes, and into one salon workflow.",points:["Point 01","Point 02","Point 03","Point 04"],titles:["Move on from paper, Excel, and notes","Organize around your salon workflow","Connect orders, receiving, and documents","Visualize cost and usage trends"],bodies:["Import from Excel/CSV to start from an existing inventory sheet, then manage the salon workflow in one place.","Organize products by supplier, maker, and category in the view that fits your salon.","Create order sheets or order messages by supplier, register receiving when items arrive, and save receipts, delivery notes, and invoices.","Use inventory and usage data to review material cost ratio and product trends later."]},
      ...
      pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","30-day free trial planned","¥4,980 / month planned","¥9,800 / month~ planned"],subs:["","Then ¥1,980/month or ¥19,800/year planned","¥49,800/year planned",""],titles:["For salons that want to try first","For solo and small salons running seriously","For teams and multiple devices","For multi-store, integrations, and automation"],descriptions:["A free starter to try the flow from photos and barcodes to orders, receiving, and receipt storage.","A plan to try product registration, photo storage, order sheets, receiving, and receipt management in real salon work.","For salons that want multiple staff, multiple devices, and cloud backup.","For salons considering multiple stores, external integrations, AI/OCR, and advanced operation."],features:[["Up to 50 products","Up to 30 photos","Up to 10 documents","Up to 50MB document storage","Up to 3 suppliers","1 staff / 1 device","Up to 10 order sheets per month","Up to 3 Excel order templates per month","Simple material cost display","Manual JSON backup only","No cloud sync"],["All Free Starter features","300 products","300 photos","1GB document storage","30 suppliers","Relaxed order sheet limits","Relaxed Excel order template limits","Supplier / maker / category organization","Receipt / delivery note / invoice management","Material cost report","JSON backup","Mac / Windows versions planned"],["All Starter features","B-tory account","Cloud backup","Multi-device sync","Staff sharing","Operation history","Advanced analysis","More document capacity","More photo capacity"],["All Pro features","Multi-store support","POS / booking site integrations","Accounting integration","AI/OCR","LINE official integration","WhatsApp Business","Dedicated support"]],buttons:["Free Starter planned","30-day trial in preparation","Pro in preparation","Max in preparation"],notes:["* Prices, functions, and free trials are planned. The first release is planned to start with Free Starter.","* Starter trial, paid plans, accounts, cloud backup, multi-device sync, AI/OCR, and external integrations are under consideration for future updates."]},
    ...
    ja:{
      ...
      features:{eyebrow:"B-toryなら",title:"サロンの在庫管理業務を効率化。",body:"紙・Excel・メモに散らばりがちな在庫、発注、納品、領収書、材料費の情報を、サロンワークに沿った流れにまとめます。",points:["ポイント 01","ポイント 02","ポイント 03","ポイント 04"],titles:["紙・Excel・メモから脱却","サロンに合わせて整理","発注・納品・書類までつながる","材料費率・使用傾向を見える化"],bodies:["Excel/CSVから取り込み、既存の在庫表をもとにサロン管理を始められます。","仕入先別・メーカー別・カテゴリ別に、サロンの管理しやすい見方で商品を整理できます。","仕入先ごとに発注書や本文を作成し、届いたら納品登録。領収書・納品書・請求書も保存できます。","在庫や使用データから、材料費率や薬剤使用の傾向を確認し、あとから振り返れます。"]},
      ...
      pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","30日無料トライアル予定","¥4,980/月 予定","¥9,800/月〜 予定"],subs:["","その後 ¥1,980/月・年額 ¥19,800/年 予定","年額 ¥49,800/年 予定",""],titles:["まず試したいサロンに","一人サロン・小規模サロンの本格運用に","チーム運用・複数端末に","複数店舗・連携・自動化に"],descriptions:["写真・バーコード・発注・納品・領収書保存の流れを、小さく試せる無料スターター。","商品登録、写真保存、発注書作成、納品登録、領収書管理まで、実際のサロン業務でしっかり試せるプラン。","複数スタッフ、複数端末、クラウドバックアップを使いたいサロン向け。","複数店舗、外部連携、AI/OCRなどの高度な運用を検討するサロン向け。"],features:[["商品登録 50件まで","写真登録 30枚まで","書類保存 10件まで","書類容量 50MBまで","仕入先 3件まで","スタッフ 1名 / 端末 1台","発注書作成 月10件まで","Excelテンプレート発注書 月3件まで","材料費率は簡易表示","バックアップは手動JSONのみ","クラウド同期なし"],["Free Starterの全機能","商品登録 300件","写真登録 300枚","書類保存 1GB","仕入先 30件","発注書作成 制限緩和","Excelテンプレート発注書 制限緩和","仕入先別・メーカー別・カテゴリ別整理","領収書・納品書・請求書管理","材料費率レポート","JSONバックアップ","Mac / Windows版対応予定"],["Starterの全機能","B-toryアカウント","クラウドバックアップ","複数端末同期","スタッフ共有","操作履歴","詳細分析","書類容量アップ","写真容量アップ"],["Proの全機能","複数店舗","POS/予約サイト連携","会計連携","AI/OCR","LINE公式連携","WhatsApp Business","専用サポート"]],buttons:["Free Starterで開始予定","30日無料トライアル準備中","Pro準備中","Max準備中"],notes:["※価格・機能・無料トライアルは予定です。初回リリースではFree Starterから提供予定です。","※Starter 30日無料トライアル、有料プラン、アカウント機能、クラウドバックアップ、複数端末同期、AI/OCR、外部連携は今後のアップデートで提供を検討しています。"]},
      ...
      faq:{title:"よくある質問",questions:["B-toryは無料で使えますか？","Free Starterでは何ができますか？","Starterを無料で試せますか？","Starterはいくらですか？","ProやMaxはありますか？","トライアル後は自動で課金されますか？","B-toryはどの端末で使えますか？","PCでも使えますか？","iPhoneとPCでデータは同期できますか？","アカウント登録は必要ですか？","ExcelやNumbersの在庫表から登録できますか？","最初に全部の商品情報を入力しないと使えませんか？","パソコンが苦手でも使えますか？","発注は自動送信されますか？","POSや予約サイトと自動連携しますか？"],answers:["初回リリースでは、Free Starterとして無料で試せるプランを提供予定です。本格運用向けにStarter / Pro / Maxの有料プランも準備中です。","商品登録、写真/バーコード登録、要発注確認、発注書作成、納品登録、領収書・納品書・請求書保存などを小さく試せる予定です。登録数、写真枚数、書類保存数、保存容量には制限を設ける予定です。","Starterは30日無料トライアルを準備中です。商品登録、写真保存、発注書作成、納品登録、領収書管理など、本格運用向けの機能を実際のサロン業務で試せる予定です。","Starterは月額1,980円、年額19,800円を予定しています。一人サロン・小規模サロンの本格運用向けのプランです。価格や提供内容は正式リリース前に変更される場合があります。","Proは月額4,980円、Maxは月額9,800円〜を予定しています。クラウドバックアップ、複数端末同期、スタッフ共有、外部連携、AI/OCRなどは今後のアップデートで検討しています。","正式提供時の課金方法に合わせて、開始前に料金・期間・更新条件を分かりやすく表示します。現時点ではStarter 30日無料トライアルは準備中です。","B-toryは、iPhone・iPad・Mac・Windowsアプリとして展開予定です。まずはiOS/iPadOS版を中心に準備し、Mac/Windowsのデスクトップアプリ版も順次対応予定です。","はい。Mac/Windows向けのデスクトップアプリ版を準備予定です。公開までは公式サイトで案内します。","初回リリースでは端末内保存を中心に開始予定です。将来のアカウント機能・クラウドバックアップ・複数端末同期についても検討しています。提供する場合は、保存される情報や利用目的を明示します。","初回リリースのFree Starterは、ログインなしでも使い始められる予定です。将来のStarter / Proでは、アカウント登録、Appleログイン、Googleログイン、メール登録、クラウドバックアップなどを検討しています。","はい。CSVまたはExcel形式のファイルから商品データを取り込めるようにする予定です。Numbersを使っている場合は、Excel形式またはCSV形式で書き出してから取り込めます。まずは商品名、カテゴリ、仕入先、在庫数などをまとめて登録し、後から写真やバーコードを追加できます。","いいえ。まずは商品名と在庫数だけでも始められます。必要に応じて、カテゴリ、メーカー、仕入先、写真、バーコードを後から追加できます。","はい。最初はExcel/CSVからまとめて取り込み、その後はスマホで写真やバーコードを使って管理できます。サロンワークの流れに合わせて、少しずつ整理していける設計を目指しています。","いいえ。B-toryは発注書や発注本文を作成しますが、送信はユーザーが内容を確認して行います。","初回リリースでは自動連携は行いません。外部連携はMaxなどの将来プランで検討しています。"]},
  ...
  merge(BUSINESS_COPY.zh=BUSINESS_COPY.zh||{},{
    ...
    features:{eyebrow:"用 B-tory",title:"让沙龙库存管理更高效。",body:"把散落在纸张、Excel 和备忘中的库存、订货、入库、收据和材料费信息，整理成符合沙龙工作的流程。",points:["要点 01","要点 02","要点 03","要点 04"],titles:["摆脱纸张、Excel 和备忘","按沙龙方式整理","订货、入库和文件相连接","材料费率和使用趋势可视化"],bodies:["可从 Excel/CSV 导入，以现有库存表为基础开始沙龙管理。","按供应商、制造商和分类整理商品，使用适合沙龙的管理视图。","按供应商创建订单文件或订货正文，到货后登记入库，并保存收据、送货单和发票。","通过库存和使用数据，确认材料费率和药剂使用趋势，之后也能回顾。"]},
    plan:{eyebrow:"Pricing",title:"按沙龙规模选择计划",body:"先用 Free Starter 小规模试用，正式运营可选择 Starter。团队和多设备计划用 Pro，联动和自动化计划用 Max。"},
    pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","计划30天免费试用","¥4,980/月 计划","¥9,800/月起 计划"],subs:["","之后 ¥1,980/月 或 ¥19,800/年 计划","¥49,800/年 计划",""],titles:["想先试用的沙龙","一人沙龙和小型沙龙的正式运营","团队运营和多设备","多店铺、联动和自动化"],descriptions:["可小规模试用照片、条码、订货、入库和收据保存流程的免费入门计划。","用于在真实沙龙业务中试用商品登记、照片保存、订单、入库和收据管理。","面向希望使用多员工、多设备和云备份的沙龙。","面向考虑多店铺、外部联动、AI/OCR等高级运营的沙龙。"],features:[["商品登记最多50件","照片最多30张","文件最多10件","文件容量最多50MB","供应商最多3个","员工1名 / 设备1台","订单每月最多10件","Excel订单模板每月最多3件","材料费率简易显示","仅手动JSON备份","无云同步"],["Free Starter全部功能","商品300件","照片300张","文件1GB","供应商30个","订单创建限制放宽","Excel订单模板限制放宽","按供应商/制造商/分类整理","收据/送货单/发票管理","材料费率报告","JSON备份","Mac / Windows版计划支持"],["Starter全部功能","B-tory账号","云备份","多设备同步","员工共享","操作历史","详细分析","文件容量提升","照片容量提升"],["Pro全部功能","多店铺","POS/预约网站联动","会计联动","AI/OCR","LINE官方联动","WhatsApp Business","专属支持"]],buttons:["Free Starter 计划开始","30天试用准备中","Pro 准备中","Max 准备中"],notes:["※价格、功能和免费试用均为计划。首次发布计划从 Free Starter 开始。","※Starter 30天试用、付费计划、账号、云备份、多设备同步、AI/OCR和外部联动均在未来更新中考虑。"]},
  ...
  merge(BUSINESS_COPY.es=BUSINESS_COPY.es||{},{
    ...
    features:{eyebrow:"Con B-tory",title:"Haz más eficiente la gestión de inventario del salón.",body:"Reúne inventario, pedidos, recepción, recibos y datos de coste material en un flujo adaptado al trabajo del salón.",points:["Punto 01","Punto 02","Punto 03","Punto 04"],titles:["Deja atrás papel, Excel y notas","Organiza según tu salón","Conecta pedidos, recepción y documentos","Visualiza coste y tendencias"],bodies:["Importa desde Excel/CSV para empezar desde una tabla de inventario existente y gestionar el salón en un solo flujo.","Organiza productos por proveedor, fabricante y categoría con una vista que encaje con tu salón.","Crea órdenes o textos por proveedor, registra la recepción al llegar y guarda recibos, albaranes y facturas.","Usa datos de inventario y uso para revisar ratio de coste de materiales y tendencias después."]},
    ...
    pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","Prueba de 30 días prevista","¥4,980/mes previsto","Desde ¥9,800/mes previsto"],subs:["","Después ¥1,980/mes o ¥19,800/año previsto","¥49,800/año previsto",""],titles:["Para salones que quieren probar","Para salones pequeños y de una persona","Para equipos y varios dispositivos","Para multi-sede, integraciones y automatización"],descriptions:["Starter gratuito para probar fotos, códigos, pedidos, recepción y guardado de recibos en pequeño.","Para probar registro de productos, fotos, órdenes, recepción y recibos en el trabajo real del salón.","Para salones que quieren varios miembros, varios dispositivos y backup en la nube.","Para salones que consideran varias sedes, integraciones, AI/OCR y operación avanzada."],features:[["Hasta 50 productos","Hasta 30 fotos","Hasta 10 documentos","Hasta 50MB para documentos","Hasta 3 proveedores","1 persona / 1 dispositivo","Hasta 10 órdenes al mes","Hasta 3 plantillas Excel al mes","Coste de materiales simple","Solo backup JSON manual","Sin sincronización en nube"],["Todas las funciones de Free Starter","300 productos","300 fotos","1GB de documentos","30 proveedores","Límites de órdenes ampliados","Límites de Excel ampliados","Organización por proveedor/fabricante/categoría","Recibos/albaranes/facturas","Reporte de coste material","Backup JSON","Versiones Mac / Windows previstas"],["Todo Starter","Cuenta B-tory","Backup en la nube","Sincronización multi-dispositivo","Compartir con staff","Historial de acciones","Análisis avanzado","Más capacidad de documentos","Más capacidad de fotos"],["Todo Pro","Varias sedes","Integración POS / reservas","Integración contable","AI/OCR","LINE oficial","WhatsApp Business","Soporte dedicado"]],buttons:["Free Starter previsto","Prueba de 30 días en preparación","Pro en preparación","Max en preparación"],notes:["* Precios, funciones y pruebas gratuitas están previstos. El primer lanzamiento está previsto con Free Starter.","* La prueba de Starter, planes de pago, cuentas, backup en nube, sincronización, AI/OCR e integraciones se consideran para futuras actualizaciones."]},
