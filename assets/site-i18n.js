(function(){
  ...
  var COPY={
    en:{
      ...
      difference:{
        ...
        visualLabels:["Excel / CSV","Product","Photo","Barcode","Stock 7","Reorder","Order sheet","Waiting","Receiving","Stock 2→8","Receipt","Delivery note","Invoice","Search","Material cost"]
      },
      workflow:{
    ...
    ja:{
      ...
      difference:{
        ...
        visualLabels:["Excel / CSV","商品登録","写真","バーコード","在庫 7","要発注","発注書","入荷待ち","納品","在庫 2→8","領収書","納品書","請求書","検索","材料費率"]
      },
      workflow:{
        eyebrow:"How it works",
        title:"基本の流れ",
  ...
  var BUSINESS_COPY={
    ...
    ja:{
      ...
      pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","¥1,980/月","¥4,980/月 予定","¥9,800/月〜 予定"],subs:["","年額 ¥19,800/年 予定","年額 ¥49,800/年 予定",""],titles:["まず試したいサロンに","一人サロン・小規模サロンの本格運用に","チーム運用・複数端末に","複数店舗・連携・自動化に"],descriptions:["B-toryの基本フローを小さく試せる体験用プラン。本格的な在庫・発注・領収書管理にはStarterをおすすめします。","日々の在庫確認、発注、納品、領収書管理をしっかり使いたいサロン向け。B-toryの中心プランです。","複数スタッフ、複数端末、クラウドバックアップを使いたいサロン向け。","複数店舗、外部連携、AI/OCRなどの高度な運用を検討するサロン向け。"],features:[["商品登録 20件まで","写真登録 10枚まで","書類保存 5件まで","書類容量 20MBまで","仕入先 2件まで","スタッフ 1名 / 端末 1台","発注書作成 月3件まで","Excelテンプレート発注書 月1件まで","材料費率は簡易表示のみ","バックアップは手動JSONのみ","クラウド同期なし","複数端末同期なし","スタッフ共有なし"],["Free Starterの全機能","商品登録 300件","写真登録 300枚","書類保存 1GB","仕入先 30件","発注書作成 制限緩和","Excelテンプレート発注書 制限緩和","仕入先別・メーカー別・カテゴリ別整理","領収書・納品書・請求書管理","材料費率レポート","JSONバックアップ","Mac / Windows版対応予定"],["Starterの全機能","B-toryアカウント","クラウドバックアップ","複数端末同期","スタッフ共有","操作履歴","詳細分析","書類容量アップ","写真容量アップ"],["Proの全機能","複数店舗","POS/予約サイト連携","会計連携","AI/OCR","LINE公式連携","WhatsApp Business","専用サポート"]],buttons:["Free Starterで開始予定","Starter準備中","Pro準備中","Max準備中"],notes:["※価格・機能・無料トライアルは予定です。初回リリースではFree Starterから提供予定です。","※Starter 30日無料トライアル、有料プラン、アカウント機能、クラウドバックアップ、複数端末同期、AI/OCR、外部連携は今後のアップデートで提供を検討しています。"]},
  ...
  merge(BUSINESS_COPY.zh=BUSINESS_COPY.zh||{},{
    ...
    pricing:{labels:["Free Starter","Starter","Pro","Max"],prices:["¥0","¥1,980/月","¥4,980/月 计划","¥9,800/月起 计划"],subs:["","¥19,800/年 计划","¥49,800/年 计划",""],titles:["想先试用的沙龙","一人沙龙和小型沙龙的正式运营","团队运营和多设备","多店铺、联动和自动化"],descriptions:["可小规模试用 B-tory 基本流程的体验版。正式的库存、订货和收据管理建议使用 Starter。","面向希望扎实使用每日库存确认、订货、入库和收据管理的沙龙。B-tory 的核心计划。","面向希望使用多员工、多设备和云备份的沙龙。","面向考虑多店铺、外部联动、AI/OCR等高级运营的沙龙。"],features:[["商品登记最多20件","照片最多10张","文件最多5件","文件容量最多20MB","供应商最多2个","员工1名 / 设备1台","订单每月最多3件","Excel订单模板每月最多1件","材料费率仅简易显示","仅手动JSON备份","无云同步","无多设备同步","无员工共享"],["Free Starter全部功能","商品300件","照片300张","文件1GB","供应商30个","订单创建限制放宽","Excel订单模板限制放宽","按供应商/制造商/分类整理","收据/送货单/发票管理","材料费率报告","JSON备份","Mac / Windows版计划支持"],["Starter全部功能","B-tory账号","云备份","多设备同步","员工共享","操作历史","详细分析","文件容量提升","照片容量提升"],["Pro全部功能","多店铺","POS/预约网站联动","会计联动","AI/OCR","LINE官方联动","WhatsApp Business","专属支持"]],buttons:["Free Starter 计划开始","Starter 准备中","Pro 准备中","Max 准备中"],notes:["※价格、功能和免费试用均为计划。首次发布计划从 Free Starter 开始。","※Starter 30天试用、付费计划、账号、云备份、多设备同步、AI/OCR和外部联动均在未来更新中考虑。"]},
